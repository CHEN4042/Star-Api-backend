...
import cn.haoc.starapicommon.common.*;
import cn.hutool.json.JSONUtil;
import cn.haoc.starapiadmin.annotation.AuthCheck;
import cn.haoc.starapiadmin.config.GatewayConfig;
import cn.haoc.starapiadmin.exception.BusinessException;
import cn.haoc.starapiadmin.exception.ThrowUtils;
import cn.haoc.starapiadmin.service.InterfaceInfoService;
import cn.haoc.starapiadmin.service.UserService;
import cn.haoc.starapicommon.constant.CommonConstant;
import cn.haoc.starapicommon.constant.UserConstant;
import cn.haoc.starapicommon.model.dto.interfaceinfo.InterfaceInfoAddRequest;
import cn.haoc.starapicommon.model.dto.interfaceinfo.InterfaceInfoInvokeRequest;
import cn.haoc.starapicommon.model.dto.interfaceinfo.InterfaceInfoQueryRequest;
import cn.haoc.starapicommon.model.dto.interfaceinfo.InterfaceInfoUpdateRequest;
import cn.haoc.starapicommon.model.entity.InterfaceInfo;
import cn.haoc.starapicommon.model.entity.User;
import cn.haoc.starapicommon.model.enums.InterfaceInfoStatusEnum;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        // 获取SDK客户端
        StarApiClient starApiClient = interfaceInfoService.getStarApiClient(request);
        // 设置网关地址
        starApiClient.setGatewayHost(gatewayConfig.getHost());
        try {
            // 执行方法
            String invokeResult = starApiClient.invokeInterface(requestParams, url, method);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        try {
            // 执行方法
            invokeResult = starApiClient.invokeInterface(requestParams, url, method);
            if (StringUtils.isBlank(invokeResult)) {
                throw new BusinessException(ErrorCode.SYSTEM_ERROR, "接口数据为空");
            }
        } catch (Exception e) {
