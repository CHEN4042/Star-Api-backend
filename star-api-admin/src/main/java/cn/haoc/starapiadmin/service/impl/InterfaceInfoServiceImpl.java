...
import cn.haoc.starapicommon.model.vo.RequestParamsRemarkVO;
import cn.haoc.starapicommon.model.vo.ResponseParamsRemarkVO;
import cn.haoc.starapicommon.model.vo.UserVO;
...
public class InterfaceInfoServiceImpl extends ServiceImpl<InterfaceInfoMapper, InterfaceInfo>
    ...
    @Override
    public StarApiClient getStarApiClient(HttpServletRequest request) {
        // 获取当前登录用户
        User loginUser = userService.getLoginUser(request);
