...
import cn.haoc.starapiadmin.mapper.UserMapper;
...
import cn.haoc.starapicommon.model.dto.user.UserQueryRequest;
import cn.haoc.starapicommon.model.entity.User;
import cn.haoc.starapicommon.model.enums.UserRoleEnum;
import cn.haoc.starapicommon.model.vo.LoginUserVO;
...
import static cn.haoc.starapicommon.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public boolean userLogout(HttpServletRequest request) {
        log.info((String) request.getSession().getAttribute(USER_LOGIN_STATE));
