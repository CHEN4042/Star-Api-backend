package cn.haoc.starapigateway.filter;

import cn.haoc.starapigateway.exception.BusinessException;
...
public class CustomGlobalFilter implements GlobalFilter, Ordered {
    ...
    private final static List<String> WHITE_HOST_LIST = Arrays.asList("127.0.0.1", "47.120.69.56","183.211.161.225");
